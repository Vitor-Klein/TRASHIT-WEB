...
function Politica() {
  ...
  return (
    <div className="containerPolitica">
      <span>
        Esta política é válida a partir de Nov 2022.

        Política de Privacidade - Trash-It
        Trash-It, pessoa jurídica de direito privado leva a sua privacidade a sério e zela pela segurança e proteção de dados de todos os seus clientes, parceiros, fornecedores e usuários do site domínio https://trash-it.vercel.app e qualquer outro site, loja ou aplicativo operado pelo lojista.
        ...
        Esta Política de Privacidade fornece uma visão geral de nossas práticas de privacidade e das escolhas que você pode fazer, bem como direitos que você pode exercer em relação aos Dados Pessoais tratados por nós. Se você tiver alguma dúvida sobre o uso de Dados Pessoais, entre em contato com vitorhklein2@gmil.com.
        ...
        Caso pretenda exercer qualquer um dos direitos previstos, inclusive retirar o seu consentimento, nesta Política de Privacidade e/ou nas Leis de Proteção de Dados, ou resolver quaisquer dúvidas relacionadas ao Tratamento de seus Dados Pessoais, favor contatar-nos em vitorhklein2@gmil.com.
      </span>
    </div>
  )
}
